...
* Joey
  * Added variable pitch range
  * Prepared game and presentation for beta release
  * Goals:
    * Migrate frequency-position translation into Game.tsx
    * Add grid lines for notes to game canvas
